...
bag's fitting rows.  It runs the same fixed 500-step cosine trajectory,
retains the validation-best *trained* checkpoint, and only then applies a
Retouche-style 0.5% post-training identity guard.  The saved outer-test
prediction is the mean of those eight guarded members.  No outer-test label
selects a checkpoint, a guard, an architecture, or an ensemble member.
...
-------
    ...
    /home/eng/zusmang/try_micormamba/.venv_311_ticl/bin/python \
      ...
      --output-dir /home/dsi/zusmang/TabICL/tabicl/results/openml_direct_spline_adaptive_retouche/multiclass_seed20260828 \
